...
VALUES
    ('Ingénieur en Chef', 'Excellente supervision', 6, 1),
    ('Architecte', 'Très compétent', 7, 2),
    ('Directeur Marketing', 'Très impliqué', 8, 3),
    ('Chef de Projet', 'Très expérimenté', 9, 4),
    ('Directeur Financier', 'Très compétent', 10, 5);
